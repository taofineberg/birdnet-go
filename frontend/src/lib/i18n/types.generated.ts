...
export type TranslationKey =
  ...
  | 'settings.audio.chunkUpload.title'
  | 'settings.audio.chunkUpload.description'
  | 'settings.audio.chunkUpload.enable'
  | 'settings.audio.chunkUpload.enableHelp'
  | 'settings.audio.chunkUpload.disabled'
  | 'settings.audio.chunkUpload.tokenLabel'
  | 'settings.audio.chunkUpload.tokenPlaceholder'
  | 'settings.audio.chunkUpload.tokenHelp'
  | 'settings.audio.chunkUpload.save'
  | 'settings.audio.chunkUpload.saveHelp'
  | 'settings.audio.chunkUpload.pathLabel'
  | 'settings.audio.chunkUpload.pathHelp'
  | 'settings.audio.chunkUpload.maxSizeLabel'
  | 'settings.audio.chunkUpload.maxSizeHelp'
  | 'settings.audio.chunkUpload.maxSecondsLabel'
  | 'settings.audio.chunkUpload.maxSecondsHelp'
  | 'settings.audio.chunkUpload.endpointTitle'
  | 'settings.audio.chunkUpload.endpointDescription'
  | 'settings.audio.chunkUpload.endpoint'
  | 'settings.audio.chunkUpload.authorization'
